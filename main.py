...
class PatientData(BaseModel):
    ...
    @field_validator('gender', 'poor_diet', 'viruses', 'smoking', 'micro_infarcts', 'depression', 'early_stress', 'air_pollution', 'calcium_deficiency', 'alcohol', 'organic_solvents', 'vitamin_deficiency', 'dental_infection', 'fungi_infection', 'bacteria_infection', 'lack_of_cognitive_activity', 'poor_cholesterol_homeostasis', 'cardiovascular_disease', 'congestive_heart_failure', 'metals', 'malnutrition', 'immune_system_dysfunction', 'obesity', 'poor_controlled_type2_diabetes', 'stroke', 'family_history_of_dementia', 'traumatic_brain_injury', 'cancer')
    @classmethod
